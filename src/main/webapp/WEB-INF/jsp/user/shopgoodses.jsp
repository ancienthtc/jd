...
<div class="head">
    ...
    <div class="h_right">
        <ul>
            ...
            <li><a herf="javascript:void(0)" onclick="window.location.href='<%=basePath%>user/toShopCenter'">用户管理</a></li>
    ...
    <div class="main_r">
        <ul>
            <c:forEach var="goods" items="${allgoods}">
                <li>
                    <a href="<%=basePath%>goods/getGoods/${goods.id}">
                        <img src="<%=basePath%>picture/show?pic=${goods.title}">
                        <br>
