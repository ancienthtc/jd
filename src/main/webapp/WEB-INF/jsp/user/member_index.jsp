    ...
    <div id="lib_user" class="clearfix">
        ...
        <div id="lib_user_menu">
            ...
            <ul>
                ...
                <%--<li><a rel="nofollow" href="<%=basePath%>member_orders.htm">My Orders</a></li>--%>
        ...
        <div id="lib_user_main">
            ...
            <dl id="lib_user_welcome">
                <dt>Welcome</dt>
                <dd>Welcome to your account dashboard. Select below to update your personal details, communication
                    preferences and view your order history.
                </dd>
            </dl>
            ...
            <div class="index_ml index_boxes">
                <div class="index_item personal">
                    ...
                    <ul>
                        <li><b>Tel:</b>${sessionScope.user.tel}</li>
                        <li><b>Sex:</b>${sessionScope.user.sex}</li>
                        <li><b>Birth:</b>${sessionScope.user.birth}</li>
                        <li><b>Consumption:</b><a href="<%=basePath%>login/view">To go shopping ...</a></li>
                    </ul>
                </div>
                <div class="index_item address">
                    ...
                    <div class="link"><a href="<%=basePath%>member_add.htm">Add</a><a href="<%=basePath%>address/AddressEdit">More</a></div>
                </div>
            </div>
            <div class="index_mr index_boxes index_item orders">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <c:forEach var="item" items="${orders}">
                        <tr class="odd">
                            <td>${item.ordertime.toLocaleString()}</td>
                            <td><a href="<%=basePath%>order/mOrder/${item.uuid}">${item.uuid}</a></td>
                            <td>$${item.allprice}</td>
                            <td>
                                <c:choose>
                                    ...
                                    <c:when test="${item.paystatus==1 && item.shopstatus==0}">
                                        Awaiting Delivery
                                    </c:when>
                                    <c:when test="${item.paystatus==1 && item.shopstatus==1}">
                                        Awaiting Receipt
                                    </c:when>
                                    <c:when test="${item.paystatus==1 && item.shopstatus==2}">
                                        Awaiting Evaluate
                                    </c:when>
                                    <c:when test="${item.paystatus==1 && item.shopstatus==3}">
                                        Evaluation Completion
                                    </c:when>
                                    <c:when test="${item.paystatus==2}">
                                        Order Cancel
                                    </c:when>
                                </c:choose>
                            </td>
                    ...
                    <%--<tr class="odd">--%>
                        <%--<td>09/12/2017</td>--%>
                        <%--<td><a href="pro.htm">17091217094179</a></td>--%>
                        <%--<td>$65.44</td>--%>
                        <%--<td>Awaiting Payment</td>--%>
                    <%--</tr>--%>

                </table>
                <div class="link"><a href="<%=basePath%>member_ofders.htm">More</a></div>
            </div>
            <div class="blank20"></div>
            <div class="index_ml index_boxes index_item service">
                <h4>The service help</h4>
                <ul>
                    <li><a href="  ">公告暂未开放</a></li>
                    <%--<li><a href="<%=basePath%>member_sysinfo_list.htm">system info</a></li>--%>
                    <%--<li><a href="<%=basePath%>member_sysinfo_list.htm">system info</a></li>--%>
                    <%--<li><a href="<%=basePath%>member_sysinfo_list.htm">system info</a></li>--%>
                    <%--<li><a href="<%=basePath%>member_sysinfo_list.htm">system info</a></li>--%>
                </ul>
            ...
            <div class="index_mr index_boxes index_item favorites">
                ...
                <div class="viewport">
                    <ul class="list">
                        ...
                        <li><span class="photo"><a href="pro.htm" target="_blank"><img
                                src="<%=basePath%>picture/leftpro.jpg"/></a></span><a href="pro.htm" class="name" target="_blank">Product
                            Name</a></li>
                        <li><span class="photo"><a href="pro.htm" target="_blank"><img
                                src="<%=basePath%>picture/leftpro.jpg"/></a></span><a href="pro.htm" class="name" target="_blank">Product
                            Name</a></li>
                ...
                <div class="link"><a href="<%=basePath%>part/prolist">More</a></div>
