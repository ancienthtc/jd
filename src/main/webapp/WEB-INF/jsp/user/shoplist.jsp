...
<!--main开始-->
.main{margin-top:35px; width:150px; height:850px; background-color:#993;}
...
.main_r{ float:right; margin-right:80px; margin-top:-220px; margin-left:80px;}
.main_r ul li{ list-style:none; float:left; margin-left:30px; margin-top:20px;}
.main_r img{width:250px; height:auto;}
<!--底部版权开始-->
