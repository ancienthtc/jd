    ...
    <div id="lib_user" class="clearfix">
        <div id="lib_user_crumb" class="widget">
            <ul class="crumb_box clearfix">
                ...
                <li class="crumb2 root"><a href="<%=basePath%>member_index.htm">My Account<i></i></a></li>
            </ul>
        </div>
        <div id="lib_user_menu">
            <h3 class="title">My Account</h3>
            <ul>
                <li><a href="<%=basePath%>member_index.htm">Basic Information</a></li>
                ...
                <li><a href="<%=basePath%>index.htm">Sign Out</a></li>
            </ul>
        </div>
        <div id="lib_user_main">
            <%--<script type="text/javascript">--%>
                ...
                <%--});--%>
            <%--</script>--%>
            <h1 class="lib_user_title">Manage Address Book
                <span class="big"><a id="addAddress" class="textbtn" href="javascript:void(0);">Add a New Shipping Address</a></span>
            </h1>
            <div id="lib_user_address" class="index_pro_list clearfix">

                <c:if test="${not empty main}">
                    <div class="billing_addr fl">
                        <h3 class="big">Your Main Address</h3>
                        <div class="clear"></div>
                        <div class="clear"></div>

                        <ul class="addr_item">
                            <li><strong>${main.area}</strong></li>
                            <li>${main.province} / ${main.city}</li>
                            <li>${main.detail}</li>
                            <li>zip:${main.zip}</li>
                            <li>${main.recipient}</li>
                            <li><span class="phone_icon">Tel:${main.tel}</span></li>
                            <li><span class="phone_icon">Phone:${main.phone}</span></li>
                            <li>
                                <a name="${main.id}" which="edit" class="textbtn" href="javascript:void(0);" addrid="2">Edit</a>
                                <a name="${main.id}" which="del" class="textbtn" href="javascript:void(0);" addrid="2">Delete</a>
                            </li>
                        </ul>
                    </div>
                </c:if>
                ...
                <c:forEach var="item" items="${other}" >
                    <div class="billing_addr fl">
                        <h3 class="big">Your Other Address</h3>
                        <div class="clear"></div>
                        <div class="clear"></div>

                        <ul class="addr_item">
                            <li><strong>${item.area}</strong></li>
                            <li>${item.province} / ${item.city}</li>
                            <li>${item.detail}</li>
                            <li>zip:${item.zip}</li>
                            <li>${item.recipient}</li>
                            <li><span class="phone_icon">Tel:${item.tel}</span></li>
                            <li><span class="phone_icon">Phone:${item.phone}</span></li>
                            <li>
                                <a  name="${item.id}" which="edit" class="textbtn" href="javascript:void(0);" addrid="2">Edit</a>
                                <a name="${item.id}" which="del" class="textbtn" href="javascript:void(0);" addrid="2">Delete</a>
                            </li>
                        </ul>
                    </div>
                </c:forEach>
                                ...
                                <%--<tr id="zoneId" style="">--%>
                                    ...
                                    <%--<td>--%>
                                        ...
                                        <%--<div class="chzn-container chzn-container-single" style="width:310px">--%>
                                            <%--<a href="javascript:void(0)" class="chzn-single" tabindex="0"><span>Please select---</span>--%>
                                                <%--<div><b></b></div>--%>
                                            <%--</a>--%>
                                            <%--<div class="chzn-drop" style="left: -9000px; width: 308px;">--%>
                                                <%--<div class="chzn-search clearfix"><input type="text" autocomplete="off"--%>
                                                                                         <%--tabindex="-1" class=""></div>--%>
...
<script type="text/javascript">
    $(function () {
        $(".textbtn").click(function () {
            if( $(this).attr("which")=="edit" )  //编辑
            {
                var id=$(this).attr("name");
                ajax_edit(id);
            }
            else if( $(this).attr("which")=="del" )  //删除
            {
                var id=$(this).attr("name");
                ajax_del(id);
            }
...
//        });
    ...
    //打开新增页面
    function ajax_open() {
        var url = "<%=basePath%>address/getAddressForm";
    ...
    function ajax_edit(id) {
        var url = "<%=basePath%>address/getEditAddressForm/"+id;
        $.post(url,function(result){ //通过Ajax发送请求到后台
            layer.open({
                type : 1,  //获取页面层信息
                skin : "layui-layer-molv",
