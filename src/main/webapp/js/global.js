	...
	$('.product_inquiry').on('click',function(){
		if($(this).data('user')){
			...
			var html='<div id="inbox_popup">';
					...
					html+='<form action="/account/" method="post" name="inbox_popup_form" enctype="multipart/form-data">';
						...
						html+='<div class="inbox_popup_container">';
							...
							html+='<div class="inbox_popup_input">';
								html+='<div class="inbox_popup_upload">';
									html+='<input class="upload_input" type="text" id="textfield" />';
									html+='<input class="upload_button" type="button" value="Upload" />';
									html+='<div class="clear"></div>';
									html+='<input class="upload_file" type="file" name="PicPath" accept="image/gif,image/jpeg,image/png" onchange="document.getElementById(&apos;textfield&apos;).value=this.value" />';
								html+='</div>';
							html+='</div>';
							html+='<div class="clear"></div>';
						html+='</div>';
