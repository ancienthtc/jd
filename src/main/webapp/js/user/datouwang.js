...
$(function(){
	...
	$('.pre').click(function(){
		var h2title=$(this).parents('.box-datouwang').find('.on').prev('li').find('h2').text();
		var ptitle=$(this).parents('.box-datouwang').find('.on').prev('li').find('p').text();
		$('.intro h2').text(h2title);
		$('.intro p').text(ptitle);
		$(this).parents('.box-datouwang').find('.on').removeClass('on').prev().addClass('on');
	...
	$('.next').click(function(){
		    var h2title=$(this).parents('.box-datouwang').find('.on').next('li').find('h2').text();
			var ptitle=$(this).parents('.box-datouwang').find('.on').next('li').find('p').text();
			$('.intro h2').text(h2title);
			$('.intro p').text(ptitle);
			$(this).parents('.box-datouwang').find('.on').removeClass('on').next().addClass('on');
			var qsrc=$('.on').find('img').attr('src');
